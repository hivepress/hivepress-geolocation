const attachShadow=Element.prototype.attachShadow;Element.prototype.attachShadow=function(a){if("gmp-place-autocomplete"===this.localName&&!1){const b=attachShadow.call(this,{...a,mode:"open"}),c=document.createElement("style");return c.textContent=`
      .widget-container {
